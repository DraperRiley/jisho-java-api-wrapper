...
/**
 *
 * Encapsulation of the Jisho.org API using Google's GSON library to parse JSON
 *
 * @author Riley Draper
 * @version 1.0
 *
...
public class Jisho {
    ...
    /**
     * Perform a search of a given word via Jisho.org. Refer to Jisho.org regarding search methods
     *
     * @param searchWord the desired search word. Refer to Jisho.org regarding search methods
     * @throws IOException
     */
     ...
     * @param entryNum The respective "data" entry from which to pull the "slug" from
     ...
     * @param entryNum The respective "data" entry from which to pull the "is_common" from
    ...
    /**
     * Retrieve an integer representing the size of the "tags" field in a given "data" entry
     * @param entryNum The respective "data" entry from which to pull the "tags" size from
    ...
    /**
     * Retrieve an integer representing the size of the "jlpt" field in a given "data" entry
     * @param entryNum The respective "data" entry from which to pull the "tags" size from
     ...
     * @param entryNum The respective "data" entry from which to pull the "jlpt" from
    ...
    /**
     * Retrieve an integer representing the size of the "japanese" field in a given "data" entry
     * @param entryNum The respective "data" entry from which to pull the "japanese" size from
    ...
    /**
     * Retrieve a "word" entry from a given "japanese" entry under a given "data" entry
     * @param entryNum The desired "data" entry
    ...
    /**
     * Retrieve a "reading" entry from a given "japanese" entry under a given "data" entry
     * @param entryNum The desired "data" entry
     * @param japaneseNum The desired "jlpt" entry
    ...
    /**
     * Retrieve an integer representing the size of the "senses" field in a given "data" entry
     * @param entryNum The respective "data" entry from which to pull the "senses" size from
    ...
    /**
     * Retrieve an integer representing the size of the "english_definitions" field in a given "senses" entry under a given "data" entry
     * @param entryNum The desired "data" entry
    ...
    /**
     * Retrieve a "english_definitions" entry from a given "senses" entry under a given "data" entry
     * @param entryNum The desired "data" entry
     * @param sensesNum The desired "senses" entry
    ...
    /**
     * Retrieve an integer representing the size of the "parts_of_speech" field in a given "senses" entry under a given "data" entry
     * @param entryNum The desired "data" entry
     * @param sensesNum The desired "senses" entry
    ...
    /**
     * Retrieve a "parts_of_speech" entry from a given "senses" entry under a given "data" entry
     * @param entryNum The desired "data" entry
     * @param sensesNum The desired "senses" entry
    ...
    /**
     * Retrieve an integer representing the size of the "links" field in a given "senses" entry under a given "data" entry
     * @param entryNum The desired "data" entry
     * @param sensesNum The desired "senses" entry
    ...
    /**
     * Retrieve a "tags" entry from a given "senses" entry under a given "data" entry
     * @param entryNum The desired "data" entry
     * @param sensesNum The desired "senses" entry
    ...
    /**
     * Retrieve a "restrictions" entry from a given "senses" entry under a given "data" entry
     * @param entryNum The desired "data" entry
     * @param sensesNum The desired "senses" entry
    ...
    /**
     * Retrieve a "see_also" entry from a given "senses" entry under a given "data" entry
     * @param entryNum The desired "data" entry
     * @param sensesNum The desired "senses" entry
    ...
    /**
     * Retrieve an "antonyms" entry from a given "senses" entry under a given "data" entry
     * @param entryNum The desired "data" entry
     * @param sensesNum The desired "senses" entry
    ...
    /**
     * Retrieve a "source" entry from a given "senses" entry under a given "data" entry
     * @param entryNum The desired "data" entry
     * @param sensesNum The desired "senses" entry
    ...
    /**
     * Retrieve a "info" entry from a given "senses" entry under a given "data" entry
     * @param entryNum The desired "data" entry
     * @param sensesNum The desired "senses" entry
    ...
    /**
     * Retrieve a "sentences" entry from a given "senses" entry under a given "data" entry
     * @param entryNum The desired "data" entry
     * @param sensesNum The desired "senses" entry
    ...
    /**
     * Retrieve a "attribution" entry from a given "senses" entry under a given "data" entry
     * @param entryNum The desired "data" entry
